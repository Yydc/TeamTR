...
class BaseRollout(ABC):
    ...
    def __init__(
        ...
        self.config = omega_conf_to_dataclass(config) if config is not None else config
        self.model_config: HFModelConfig = (
            omega_conf_to_dataclass(model_config, dataclass_type=HFModelConfig) if model_config is not None else None
        )
