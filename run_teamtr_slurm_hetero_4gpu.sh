#!/bin/bash
#SBATCH --job-name=teamtr_hetero_4gpu
...
# Env + experiment settings (hetero run defaults).
...
export TEAMTR_EXPERIMENT_NAME="${TEAMTR_EXPERIMENT_NAME:-teamtr_hetero_full_4gpu}"
...
# Test-mode overrides (tune as needed).
